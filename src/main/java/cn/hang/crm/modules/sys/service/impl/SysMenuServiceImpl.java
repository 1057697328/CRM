...
import cn.hang.crm.modules.sys.dao.SysMenuPOMapper;
...
import cn.hang.crm.common.enums.Constant.MenuType;
    ...
    private List<SysMenuPO> getChildNoButton(Long menuId, List<SysMenuPO> allUserMenuList) {
        ...
        for (SysMenuPO menu : allUserMenuList) {
            ...
            if (menu.getParentId() != null) {
                if (menu.getParentId().equals(menuId) && menu.getType() != MenuType.BUTTON.getValue()) {
                    childList.add(menu);
                }
            }
        }
